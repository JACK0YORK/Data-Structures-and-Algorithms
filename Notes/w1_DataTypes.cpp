...
*   A group of variables
    ...
    so prefer {char,char,int} (CC00 IIII) to {char,int,char} (C000 IIII C000)
*/
struct good
{
    char x;
...
*   References are static pointers - they always point to the same data. 
    ...
    "Reference allows you to manipulate an object using pointer, but without the pointer syntax
